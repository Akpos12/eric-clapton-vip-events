...
export const SAMPLE_ORDERS: TicketOrder[] = [
  {
    ...
    transactionId: 'ch_3Nxp2KLq821099xZ89A',
    qrPayload: 'EC-TKT-2026-89421-DETROIT-LCA-ORCH-R2-S14S15',
    entryInstructions: 'Present this digital pass or high-res PDF at Chevrolet VIP Entry Gate. Bring photo ID matching attendee name.',
    createdAt: '2026-08-15T14:22:00Z',
    updatedAt: '2026-08-15T14:24:00Z'
  },
  {
    id: 'EC-2026-31084',
    ...
    paymentStatus: 'Payment Confirmed',
    ticketStatus: 'BOOKING CONFIRMED',
    transactionId: 'ch_4Jk119Mzp2198qAA1',
    qrPayload: 'EC-TKT-2026-31084-ATX-MOODY-PIT-A1',
    entryInstructions: 'VIP Entrance at Dell Technologies Plaza VIP Gate B.',
...
export const INITIAL_PAYMENT_METHODS: PaymentMethodConfig[] = [
  {
    id: 'pm-zelle-official',
    name: 'Zelle Direct Transfer',
    category: 'zelle',
    accountName: 'VIP Tour Operations & Concierge',
    accountNumberOrHandle: 'payments@ericclaptonvip.com',
    instructions: 'Send exact total via Zelle using your banking app. In the memo/notes section, include your Full Name and Tour Date. Upload screenshot receipt below.',
    isActive: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString()
  },
  {
    id: 'pm-bank-wire',
    name: 'Bank Wire / Fedwire Transfer',
    category: 'bank',
    accountName: 'Eric Clapton VIP Experience Tour Trust',
    accountNumberOrHandle: '4089 9182 3341 0029',
    bankName: 'JPMorgan Chase Bank, N.A.',
    routingNumber: '021000021',
    swiftBic: 'CHASUS33',
    instructions: 'Domestic or International wire transfer. Use your Booking Reference as Wire Memo. Upload wire confirmation document/receipt after initiating.',
    isActive: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString()
  },
  {
    ...
    name: 'Cash App Pay',
    category: 'cashapp',
    accountName: 'Slowhand VIP Tour Desk',
    accountNumberOrHandle: '$ClaptonVIPDesk',
    instructions: 'Send payment to $ClaptonVIPDesk. Add your name in the payment note. Take a screenshot of the completed transfer screen and attach below.',
    isActive: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString()
  },
  {
    id: 'pm-paypal-concierge',
    name: 'PayPal VIP Concierge',
    category: 'paypal',
    accountName: 'Eric Clapton Tour Logistics Ltd',
    accountNumberOrHandle: 'liaison@ericclaptonvip.com',
    instructions: 'Transfer to liaison@ericclaptonvip.com (Friends & Family / VIP Services). Take a clear screenshot of the PayPal transaction confirmation.',
    isActive: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString()
  },
  {
    id: 'pm-apple-pay',
    name: 'Apple Pay / Card Transfer',
    category: 'apple_pay',
    accountName: 'VIP Experience Concierge Line',
    accountNumberOrHandle: '+1 (313) 555-0144',
    instructions: 'Send Apple Cash / Card transfer to the VIP Concierge line. Attach the digital receipt screenshot with transaction ID.',
    isActive: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString()
  },
  {
    id: 'pm-crypto-usdt',
    name: 'Crypto (USDT / USDC / BTC)',
    category: 'crypto',
    accountName: 'VIP Tour Escrow Multi-Sig',
    accountNumberOrHandle: '0x71C2836E28EAA490A5092a472c6F93F2B8D24E31',
    instructions: 'Send USDT (ERC-20 or TRC-20) to the multi-sig escrow wallet. Attach tx hash screenshot or receipt once transaction is confirmed on-chain.',
    isActive: true,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString()
  }
